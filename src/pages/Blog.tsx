...
const blogPosts = {
  todos: [
    ...
    },
    {
      ...
      description: "Aprendizados, desafios e a satisfação de ver as plantas crescerem.",
      date: "25/04/2025",
      category: "Plantas",
      link: "/blog/cultivando-suculentas"
    },
    {
      title: "Um dia na vida do meu cachorro",
      description: "Crônica bem-humorada sobre a rotina do meu companheiro canino.",
      date: "15/04/2025",
      category: "Pets",
      link: "/blog/dia-cachorro"
    },
    {
      title: "Organizando minha biblioteca pessoal",
      description: "Como cataloguei e organizei anos de acúmulo de livros físicos e digitais.",
      date: "08/04/2025",
    ...
    },
    {
      ...
      description: "O que aprendi ao me desconectar temporariamente do mundo digital.",
      date: "28/03/2025",
  ...
  plantas: [
    ...
    },
    {
      ...
      description: "Dicas práticas que aprendi para recuperar plantas em estado crítico.",
      date: "10/02/2025",
      category: "Plantas",
  ...
  pets: [
    ...
    {
      title: "Como ensinar truques novos para cães adultos",
      description: "Técnicas que funcionaram com meu cão de 8 anos.",
      date: "20/02/2025",
      category: "Pets",
      link: "/blog/truques-caes-adultos"
    }
  ],
  reflexoes: [
    {
    ...
    },
    {
      ...
      description: "Como a astronomia amadora me ensinou sobre paciência e perspectiva.",
      date: "15/12/2024",
      category: "Reflexões",
    ...
    <div className="container mx-auto px-4 py-10">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg mb-10 text-muted-foreground">
          Um espaço mais livre e pessoal, onde compartilho histórias, reflexões e experiências
          sobre diversos temas do meu dia a dia.
        </p>
        ...
        <Tabs defaultValue="todos" className="mb-8">
          ...
          {(Object.keys(blogPosts) as Array<keyof typeof blogPosts>).map((category) => (
            <TabsContent key={category} value={category} className="space-y-6">
              {blogPosts[category].map((post, index) => (
                <Card key={index} className="overflow-hidden">
                  ...
                  <CardFooter>
                    <Link to={post.link} className="text-primary hover:underline">
                      Leia mais →
                    </Link>
                  </CardFooter>
                </Card>
